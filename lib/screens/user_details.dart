...
bool validateInputs(BuildContext context, AdvancedUserDetails state) {
  if (state.activityLevel == null || state.activityLevel!.isEmpty||state.conditions == null||state.conditions.isEmpty||state.cuisines == null||state.cuisines.isEmpty||state.nutrients == null||state.nutrients.isEmpty) {
    _showSnackBar(context, 'Great start! Tap next to enter the remaining details');
    return false;
  }
...
void _submitDetails(BuildContext context,AdvancedUserDetails state) async {
  ...
  if(_pickedImage==null){
    ...
    if(_selectedGender==null||_selectedGender!.trim().isEmpty){
     ...
     if(!validateInputs(context, state))
    return;

    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (context) => const ModernLoadingScreen(message: 'Tuning your profile for a perfectly balanced lifestyle...',),
    );
...
Navigator.of(context).pushReplacement(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text(error.toString()??'Error in submitting Data'))
    );
  }
               ...
               Stack(
                 children:[
                    CircleAvatar(
                      ...
                      backgroundImage: _pickedImage!=null?FileImage(_pickedImage!,):AssetImage('assets/foods/user.png'),
                      radius: 50,
                    ),
                    if(_pickedImage!=null)
                    Positioned(
              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Form(
                    ...
                    child:Column(
                     ...
                     children: [
                      ...
                      Row(children: [
                        Expanded(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: Icon(Icons.person,color:Colors.lightGreen[400]),
                      ...
                      icon: Icon(Icons.edit, color: Colors.lightGreen[400]),
                     ),
                    ],),
                    SizedBox(height:30),
                    Row(children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration:InputDecoration(
                            prefixIcon: Icon(Icons.accessibility_new,color: Colors.lightGreen[400]),
                            labelText:'Age',
                            border:OutlineInputBorder(
                              borderRadius: BorderRadius.all(Radius.circular(10)),
                            ),
                  ...
                  Expanded(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Height (cm)',
                      prefixIcon: Icon(Icons.height, color: Colors.lightGreen[400]),
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.all(Radius.circular(10)),
                      ),
                    ),
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Weight (kg)',
                      prefixIcon: Icon(Icons.monitor_weight, color: Colors.lightGreen[400]),
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.all(Radius.circular(10)),
                      ),
                    ),
                   ...
                   Container(
                    ...
                    child: DropdownButtonFormField2<String>(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(Icons.track_changes, color: Colors.lightGreen),
                      ),
                      items: _dietaryGoals
                  ...
                  BoxShadow(
                    ...
                    offset: Offset(0, 2),
                        ...
                        offset: const Offset(0, -4), // moves the dropdown up/down
                        width: MediaQuery.of(context).size.width * 0.85, // sets dropdown width
                      ),
                    ),
                  ),
                       const SizedBox(height: 30),
                    ...
                    child: DropdownButtonFormField2<String>(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(Icons.restaurant_menu, color: Colors.lightGreen),
                      ),
                      items: _preferences
                          .map((pref) => DropdownMenuItem<String>(
                      value: pref,
                      child: Text(pref,style: TextStyle(fontSize: 16),),
                    ))
                          .toList(),
                      onChanged: (value) {
                        setState(() {
                  ...
                  BoxShadow(
                    ...
                    offset: Offset(0, 2),
                      ...
                      TextFormField(
                         ...
                         prefixIcon: Icon(Icons.warning_amber, color: Colors.redAccent),
                         ),
                       ),
                ...
                children:[
                 ElevatedButton.icon(
                      ...
                      label:Text('Next',style:TextStyle(
                              color: isDarkMode? Colors.lightGreen:const Color.fromARGB(255, 1, 49, 2), 
                              fontSize: 16
                            )),
                      ...
                      onPressed: () {
                         Navigator.push(
                                context,
                                 MaterialPageRoute(builder: (_) => AdvancedUserDetailsScreen()),
                         );
                   },
